...
public class DataSourceConfig {
    ...
    @Configuration
    @MapperScan(basePackages = "com.zky.infrastructure.elasticsearch", sqlSessionFactoryRef = "elasticsearchSqlSessionFactory")
    ...
    @Configuration
    @MapperScan(basePackages = "com.zky.infrastructure.dao", sqlSessionFactoryRef = "mysqlSqlSessionFactory")
